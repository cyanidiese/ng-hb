    ...
    BootstrapTable.prototype.initBody = function (fixedScroll) {
        ...
        for (var i = this.pageFrom - 1; i < this.pageTo; i++) {
            ...
            $.each(this.header.fields, function (j, field) {
                ...
                // TODO: Find the true way
                if ((that.options.columns[j] != undefined && that.options.columns[j].checkbox)  || (that.options.columns[j] != undefined && that.options.columns[j].radio)) {
